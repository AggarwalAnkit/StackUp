...
public class RoundedImageView extends ImageView {
    ...
    private boolean topLeftRound = true;
    private boolean topRightRound = true;
    private boolean bottomLeftRound = true;
    private boolean bottomRightRound = true;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        topLeftRound = a.getBoolean(R.styleable.RoundedImageView_riv_top_left_round, true);
        topRightRound = a.getBoolean(R.styleable.RoundedImageView_riv_top_right_round, true);
        bottomLeftRound = a.getBoolean(R.styleable.RoundedImageView_riv_bottom_left_round, true);
        bottomRightRound = a.getBoolean(R.styleable.RoundedImageView_riv_bottom_right_round, true);
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundedDrawable) {
            ((RoundedDrawable) drawable)
                    ...
                    .setOval(isOval)
                    .setIsTopLeftRound(topLeftRound)
                    .setIsTopRightRound(topRightRound)
                    .setIsBottomLeftRound(bottomLeftRound)
                    .setIsBottomRightRound(bottomRightRound);
    ...
    public void setRoundedCorners(boolean topLeftRound, boolean topRightRound, boolean bottomLeftRound, boolean bottomRightRound) {
        if (mDrawable == null) {
            return;
        }
        ...
        this.bottomLeftRound = bottomLeftRound;
        this.bottomRightRound = bottomRightRound;

        if (mDrawable instanceof RoundedDrawable) {
            ((RoundedDrawable) mDrawable)
                    .setIsTopLeftRound(topLeftRound)
                    .setIsTopRightRound(topRightRound)
                    .setIsBottomLeftRound(bottomLeftRound)
                    .setIsBottomRightRound(bottomRightRound);
